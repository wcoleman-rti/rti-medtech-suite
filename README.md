...
| Docker Compose               | V2 (image builds only) |
...
# 10. Visualize Docker topology in the browser
medtech status --dockgraph
#    http://localhost:7800
...
# Launch with observability stack (Prometheus + Loki + Grafana)
medtech run hospital --observability
#    Grafana:    http://localhost:3000
#    Prometheus: http://localhost:9090

# Launch with DockGraph topology visualizer
...
Host ports are assigned per hospital ordinal with a 1000-port stride.
Maximum **8 concurrent hospitals** before port ranges overlap with
other well-known services.

| Service             | Hospital 1 | Hospital 2 | Hospital N            |
|---------------------|------------|------------|-----------------------|
...
| DockGraph           | 7800       | —          | singleton             |

Twin and controller ports auto-increment within each hospital’s block
as ORs are added.
