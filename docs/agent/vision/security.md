...
| **T** — Tampering | Modify discovery information to corrupt topic matching | Domain | Attacker injects malicious discovery data to redirect subscriptions | `discovery_protection_kind=ENCRYPT` on Procedure and Hospital Integration databuses; PSK protection on bootstrap traffic |
