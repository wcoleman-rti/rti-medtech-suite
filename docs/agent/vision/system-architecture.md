...
**Room-level GUI navigation:** Each room GUI container (controller, twin, etc.) embeds the
`surgical_procedure.room_nav` module that creates a read-only Orchestration
