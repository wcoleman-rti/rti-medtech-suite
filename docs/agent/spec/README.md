...
| `@recording` | Verifies RTI Recording Service captures data correctly and completely | V1.2+ |
| `@replay` | Verifies RTI Replay Service replays samples correctly and subscribers process them as expected | V1.2+ |
| `@orchestration` | Tests Procedure Orchestration: Service interface, dual-mode participant, Service Host lifecycle, DDS RPC, Orchestration domain communication | V1.1+ |
